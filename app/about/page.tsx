  ...
  return (
    <>
      <Head 
        ...
        url="https://aromabiji.co/about"
        keywords="about aroma biji, Indonesian coffee heritage, artisan coffee brand, luxury coffee Indonesia, ethical coffee farming, specialty coffee story"
        image="https://aromabiji.co/images/aroma-biji-about.jpg"
      />
      <AboutPage/>
    </>
  );
