...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${SITE.url}/product`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
        // Added the main chocolate archive page
        { url: `${SITE.url}/chocolate`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    ...
    // Dynamically generate the chocolate detail routes
    const chocolateRoutes: MetadataRoute.Sitemap = chocolateProducts.map((p) => ({
        url: `${SITE.url}/chocolate/${p.id}`,
        lastModified: now,
        changeFrequency: "monthly",
        priority: 0.8,
    }));
    ...
    return [...staticRoutes, ...productRoutes, ...chocolateRoutes, ...journalRoutes];
}