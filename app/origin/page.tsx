...
export default function CoffeeOriginMap() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white py-32 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="relative w-full aspect-[2/1] md:aspect-[2/1] bg-black rounded-2xl overflow-hidden shadow-inner">
                <Image
