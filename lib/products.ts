...
export const products: Product[] = [
  {
    ...
    theme: "dark", 
    variants: [
      { id: "aceh-gayo-bean-1500", type: "Bean 1500–1700 MSL", packaging: "Box", weight: "100 g", price_idr: 210000, image: "/products/ag-1.png" },
      { id: "aceh-gayo-ground-1500", type: "Ground 1500–1700 MSL", packaging: "Pouch", weight: "100 g", price_idr: 210000, image: "/products/ag-2.png" },
      { id: "aceh-gayo-bean-1900", type: "Bean 1900–2100 MSL", packaging: "Box", weight: "100 g", price_idr: 262500, image: "/products/ag-3.png" },
      { id: "aceh-gayo-ground-1900", type: "Ground 1900–2100 MSL", packaging: "Pouch", weight: "100 g", price_idr: 262500, image: "/products/ag-4.png" },
      { id: "aceh-gayo-drip-7s", type: "Drip", packaging: "Soft Box", weight: "7 x 10 g", price_idr: 240000, image: "/products/ag-5.png" }
    ]
  },
  {
    id: "mandailing",
    ...
    theme: "dark", 
    variants: [
      { id: "mandailing-bean", type: "Bean", packaging: "Box", weight: "100 g", price_idr: 262500, image: "/products/mg-1.png" },
      { id: "mandailing-ground", type: "Ground", packaging: "Pouch", weight: "100 g", price_idr: 262500, image: "/products/mg-2.png" },
      { id: "mandailing-drip-7s", type: "Drip", packaging: "Soft Box", weight: "7 x 10 g", price_idr: 240000, image: "/products/mg-3.png" }
    ]
  },
  {
    id: "java-preanger",
    ...
    theme: "light", 
    variants: [
      { id: "java-preanger-bean", type: "Bean", packaging: "Box", weight: "100 g", price_idr: 240000, image: "/products/jp-1.png" },
      { id: "java-preanger-ground", type: "Ground", packaging: "Pouch", weight: "100 g", price_idr: 240000, image: "/products/jp-2.png" },
      { id: "java-preanger-drip-6s", type: "Drip", packaging: "Soft Box", weight: "6 x 10 g", price_idr: 165000, image: "/products/jp-3.png" }
    ]
  },
  {
    id: "lintong-nihuta",
    ...
    theme: "dark", 
    variants: [
      { id: "lintong-nihuta-bean", type: "Bean", packaging: "Box", weight: "100 g", price_idr: 285000, image: "/products/ln-1.png" },
      { id: "lintong-nihuta-ground", type: "Ground", packaging: "Pouch", weight: "100 g", price_idr: 285000, image: "/products/ln-2.png" }
    ]
  },
  {
    id: "andung-sari",
    ...
    theme: "light", 
    variants: [
      { id: "andung-sari-bean", type: "Bean", packaging: "Box", weight: "100 g", price_idr: 285000, image: "/products/as-1.png" },
      { id: "andung-sari-ground", type: "Ground", packaging: "Pouch", weight: "100 g", price_idr: 285000, image: "/products/as-2.png" }
    ]
  },
  {
    id: "alur-badak",
    ...
    theme: "dark", 
    variants: [
      { id: "alur-badak-bean", type: "Bean", packaging: "Box", weight: "100 g", price_idr: 285000, image: "/products/ab-1.png" },
      { id: "alur-badak-ground", type: "Ground", packaging: "Pouch", weight: "100 g", price_idr: 285000, image: "/products/ab-2.png" },
      { id: "alur-badak-drip-6s", type: "Drip", packaging: "Soft Box", weight: "6 x 10 g", price_idr: 135000, image: "/products/ab-3.png" }
    ]
  },
  {
    id: "collections",
    ...
    variants: [
      { id: "collections-drip-6s", type: "Drip", packaging: "Soft Box", weight: "6 x 10 g", price_idr: 165000, image: "/products/co.png" }
    ]
  },
  {
    id: "the-java",
    ...
    variants: [
      { id: "the-java-bean", type: "Bean", packaging: "Soft Box", weight: "100 g", price_idr: 165000, image: "/products/tj-1.png" },
      { id: "the-java-ground", type: "Ground", packaging: "Soft Box", weight: "100 g", price_idr: 165000, image: "/products/tj-1.png" }
    ]
  },
  {
    id: "lampung",
