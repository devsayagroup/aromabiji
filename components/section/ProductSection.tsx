    ...
    <section className="relative w-full overflow-hidden bg-canvas pt-32 pb-[12rem] md:pb-[18rem]">
      ...
      >
        {products.map((project, i) => (
          ...
          >
            <div className="absolute top-0 md:top-10 inset-x-0 p-6 md:p-8 flex flex-col items-center text-center z-30">
              <h3 className="font-style text-xl md:text-4xl text-canvas tracking-wide mb-1 md:mb-2">
                {project.name}
              </h3>
              <p className="text-[9px] md:text-[10px] tracking-[0.25em] uppercase text-canvas/70 font-medium">
                {project.origin}
              </p>
            </div>
