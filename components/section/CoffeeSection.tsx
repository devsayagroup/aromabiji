...
//          <h2 className="max-w-6xl text-4xl md:text-6xl lg:text-7xl font-headline leading-[1.05] tracking-wider text-ink uppercase">
...
//       <div className="flex flex-col justify-center items-center text-center mx-6 md:mx-20 mb-4 md:mb-8 z-40 relative">
//          <h2 className="max-w-6xl text-4xl md:text-6xl font-style leading-[1.2] tracking-wider mb-4 text-ink uppercase">
//            Our Coffee Collection
//          </h2>
//           <h1 className="max-w-4xl text-3xl md:text-3xl font-body leading-[1.05] tracking-normal text-ink/80">
//             Immerse in the Richness of Indonesian
//           </h1>
//       </div>
...
export default function CoffeeSection() {
  return (
    <section id="collection" className="relative w-full overflow-hidden bg-canvas pt-24 pb-24 md:pt-32 md:pb-32 border-t border-ink/10">
      ...
      {/* ─── CURVED SEPARATOR ──────────────────────────────────────────── */}
      <div className="h-30 mt-[-80px] bg-canvas rounded-t-[98%] flex flex-col justify-center items-center text-center relative z-40"></div>
      ...
      <div className="flex flex-col justify-center items-center text-center mx-6 md:mx-20 mb-4 md:mb-8 z-40 relative">
         ...
         {/* Updated Subheadline with high-end contrast styling */}
         <h3 className="max-w-2xl text-lg md:text-xl font-text font-light leading-relaxed tracking-wide text-ink/70">
            Sourced from the deepest volcanic terroirs and perfected over four decades. Discover a profoundly limited collection of Indonesian coffees.         
        </h3>
      </div>
