...
//   return (
//     <motion.div
//       className="group bg-[#FDFBF8] rounded-3xl overflow-hidden shadow-[0_10px_25px_rgba(63,36,16,0.08)] hover:shadow-[0_15px_40px_rgba(63,36,16,0.15)] transition-all duration-500"
//       whileHover={{ y: -6 }}
//     >
...
//       <div className="p-6">
//         <h3 className="text-2xl font-serif font-semibold text-[#3F2410] mb-1">{product.name}</h3>
//         <p className="text-sm text-[#8B6F56] mb-3">{product.origin}</p>
//         <p className="text-[#5C3B1D]/80 text-sm line-clamp-2 mb-4">{product.description}</p>

//         <div className="flex items-center justify-between">
//           <span className="text-[#3F2410] text-lg font-semibold">
//             Rp {product.variants[0].price_idr?.toLocaleString("id-ID")}
//           </span>
//           <Link
//             href={`/product/${product.id}`}
//             className="text-sm font-medium text-[#5C3B1D] hover:text-[#3F2410] transition"
//           >
//             View Details →
//           </Link>
//         </div>
